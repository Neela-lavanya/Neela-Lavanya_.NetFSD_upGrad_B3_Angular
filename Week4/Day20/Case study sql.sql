...
EXEC sp_AddNewBook ' SQL basics', 10, 25.50;
EXEC sp_AddNewBook ' C# Programming', 5, 40.00;
EXEC sp_AddNewBook ' Web Development', 8, 30.00;
EXEC sp_AddNewBook ' Database Design', 3, 35.00;
EXEC sp_AddNewBook ' java Basics', 12, 28.00;

SELECT * FROM Books;

EXEC sp_PlaceOrder 1, 2;

EXEC sp_PlaceOrder 4, 6;
